...
export function InteractiveGridPatternDemo() {
  ...
  // Start animation loop only once on component mount
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Layer 1: Background Grid Container */}
          <div
            style={{
              width: gridSize,
              height: gridSize,
          ...
          {/* Layer 2: Foreground Content (Button and Text) */}
          <div
          ...
          >
            {/* Date Button with subtle styling */}
            ...
            >
              Cybersecurity Trends and Emerging Applications
            </p>
            <p
              className="mt-4 text-lg font-medium md:text-xl"
              style={{
